angular.module('clever.management.directives.maintainOverallPane', []).directive('maintainOverallPane', function(resourceService, busyService, $modal, DEVELOPMENT_API_MAINTAIN_OVERALL_URL, DEVELOPMENT_API_REMOVE_BY_MASTER_URL, DEVELOPMENT_API_REMOVE_BY_VERSIONID_URL, DEVELOPMENT_API_REMOVE_BY_VERSIONID_URL) {
	return {
		restrict : 'E',
		transclude : true,
		scope : {
