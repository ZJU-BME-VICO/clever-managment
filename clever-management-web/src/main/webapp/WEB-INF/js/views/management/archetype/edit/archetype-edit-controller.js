function ArchetypeEditCtrl($scope, $modal, $log, $q, $timeout, msgboxService,
  ...
  $scope.$watch('isExpandedAll', function(newValue) {
    if (newValue != undefined) {
      if (newValue) {
        $scope.treeControl.expandAll();
      } else {
  ...
  $scope.getFixedTitle = function(title, length) {
    if (title) {
      ...
      if (title.length > titleLength) {
        return title.substring(0, titleLength / 2) + '...' + title.substring(title.length - titleLength / 2,
          title.length);
      } else
        return title;
    }
        ...
        function(result) {
          ...
          if (result.succeeded) {
            ...
            msgboxService.createMessageBox(
              ...
              'ARCHETYPE_EDIT_ADD_SUCCEEDED_HINT', {}, 'success');
          } else {
            msgboxService.createMessageBox(
