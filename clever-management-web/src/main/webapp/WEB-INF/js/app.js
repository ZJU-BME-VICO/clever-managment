angular.module('clever.management.directives', ['clever.management.directives.validCheck', 'clever.management.directives.api', 'clever.management.directives.commons', 'clever.management.directives.templateDesign', 'clever.management.directives.editor', 'clever.management.directives.archetypeListTree', 'clever.management.directives.archetypeListTreeNode', 'clever.management.directives.archetypeMasterPane', 'clever.management.directives.archetypePane', 'clever.management.directives.headerPane', 'clever.management.directives.participationPane', 'clever.management.directives.definitionPane', 'clever.management.directives.terminologyPane', 'clever.management.directives.treeView', 'clever.management.directives.treeViewNode', 'clever.management.directives.introduction', 'clever.management.directives.elastic', 'clever.management.directives.access', 'clever.management.directives.sideToolMenu']);
...
angular.module('clever.management.directives.editor', ['clever.management.directives.termDefinitionPane', 'clever.management.directives.nodeInfoPane', 'clever.management.directives.definitionOntologyPane', 'clever.management.directives.constraintPane', 'clever.management.directives.subjectPane', 'clever.management.directives.batchSubmitPane', 'clever.management.directives.linksPane', 'clever.management.directives.editDefinitionPane', 'clever.management.directives.editHeaderPane', 'clever.management.directives.editOntologyPane']);
angular.module('clever.management.directives.introduction', ['clever.management.directives.introductionPane']);
angular.module('clever.management.services', ['clever.management.service.rmFactoryService', 'clever.management.services.treeDataFormat', 'clever.management.services.templateCreate', 'clever.management.services.resource', 'clever.management.service.archetypeEdit', 'clever.management.service.archetypeParseEdit', 'clever.management.service.archetypeSerialize', 'clever.management.services.authentication', 'clever.management.services.busy', 'clever.management.services.msgbox', 'clever.management.services.templateParse', 'clever.management.services.templateParseToEdit', 'clever.management.services.archetypeParse', 'clever.management.services.documentDiffModal']);
angular.module('clever.management.filters', ['clever.management.filters.unsafe', 'clever.management.filters.typemap', 'clever.management.filters.typemap2display']);
